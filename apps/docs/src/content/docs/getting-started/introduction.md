---
title: Introduction
description: "Get started with Minions Bundle: Portfolio"
---
...
- **TypeScript SDK** (`@minions-bundles-portfolio/sdk`) — Core library for Node.js
- **Python SDK** (`minions-bundles-portfolio`) — Python bindings
- **CLI Tool** (`@minions-bundles-portfolio/cli`) — Command-line interface
